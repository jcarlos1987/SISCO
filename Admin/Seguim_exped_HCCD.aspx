<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master09.master" AutoEventWireup="true" CodeFile="Seguim_exped_HCCD.aspx.cs" Inherits="Admin_Control_exp_inc09_Seguim_exped_HCCD" %>
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Seguimiento de Expedientes del Honorable Consejo Consultivo Delegacional:</h5>
                <ol class="breadcrumbs">
                  ...
                  <li class="active">Seguimiento de Expedientes del Honorable Consejo Consultivo Delegacional</li>
                </ol>
              </div>
            </div>
          </div>
...
<%--                    <h4 class="header2">Comparación de Rales</h4>--%>
        ...
        <asp:GridView ID="GridView1" AutoGenerateColumns="False" runat="server" AllowPaging="true"                        
                        CellPadding="4" ForeColor="Black"  CssClass="mGrid responsive-table" AlternatingRowStyle-CssClass="alt"  
