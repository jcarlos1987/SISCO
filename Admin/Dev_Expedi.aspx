<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master09.master" AutoEventWireup="true" CodeFile="Dev_Expedi.aspx.cs" Inherits="Admin_Dev_Expedi" %>
              ...
              <div class="col s12 m12 l12">
                ...
                <ol class="breadcrumbs">
                  ...
                  <li><a href="Incidencia09.aspx">Incidencia 09</a>
                    ...
                    <li class="active">Devolución de Expedientes</li>
                </ol>
              </div>
            </div>
          </div>
          ...
          <div class="col s12 m12 l12">
                <div class="card-panel">
                    ...
                    <h4 class="header2">Información del expediente:</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col col s12 m4 l4">
                             ...
                             <div class="col col s12 m4 l8">
                                 <label>Observaciones :</label>
                                  <asp:TextBox ID="Observaciones" runat="server" TextMode="MultiLine" Rows="5"></asp:TextBox> 
                                 <div class="input-field">
                                <div class="errorTxt6"></div>    
                                    </div>                              
                            </div>
                        ...
                        <div class="col col s12 m4 l6">
                            ...
                            <%--fin responsabilidad solidaria--%>
                              ...
                              <div class="input-field col s4">
                                ...
                                <a class="waves-effect waves-light btn modal-trigger light-blue" href="#modal1">Devolver Expediente </a>     
                  ...
                  <div class="modal-content">
                    ...
                    <p>¿ Estas seguro(a) que desea generar el oficio de Devolución del Expediente con Razón Social de <b> <% Response.Write(Raz_soc.Text); %></b> y Registro Patronal <b><% Response.Write(Reg.Text); %> </b> ?</p>
                  </div>
                  <div class="modal-footer">
                      <div class="col m12 s12 l12">
                        <a href="#" class="waves-effect waves-red btn-flat modal-action modal-close red lighten-1">Cancelar</a>    
                          <asp:Button ID="Reg_Exped" runat="server" CssClass="waves-effect waves-green btn-flat modal-action modal-close cyan" Text="Aceptar" OnClick="Reg_Exped_Click" />   
                      </div>
                  </div>
                </div>
