<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master09.master" AutoEventWireup="true" CodeFile="Seguim_exped_JAC.aspx.cs" Inherits="Admin_Control_exp_inc09_Seguim_exped_JAC" %>
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Seguimiento de Expedientes de la Jefatura de Servicios de Afiliación y Cobranza</h5>
                <ol class="breadcrumbs">
                  ...
                  <li class="active">Seguimiento de Expedientes de la Jefatura de Servicios de Afiliación y Cobranza</li>
                </ol>
              </div>
            </div>
          </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="GridView1" AutoGenerateColumns="False" runat="server" 
                        CssClass="mGrid responsive-table" AlternatingRowStyle-CssClass="alt" AllowPaging="true"
                        DataKeyNames="Registro_Patronal, Razon_Social, Rango, socio, id" DataSourceID="SqlDataSource1"                          
            ...
            <ItemStyle CssClass="left-align"/>  
             ...
             <ItemStyle CssClass="center-aling"/> 
             </asp:BoundField>
