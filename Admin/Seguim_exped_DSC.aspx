<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master09.master" AutoEventWireup="true" CodeFile="Seguim_exped_DSC.aspx.cs" Inherits="Admin_Control_exp_inc09_Seguim_exped_DSC" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <asp:GridView ID="GridView1" AutoGenerateColumns="False" runat="server" 
                       CssClass="mGrid responsive-table" AlternatingRowStyle-CssClass="alt" 
                        DataKeyNames="Registro_Patronal,Razon_Social, socio,id" DataSourceID="SqlDataSource1"                          
                        onrowcommand="GridView1_RowCommand" AllowPaging="true" PageSize="19" PagerStyle-CssClass="pgr">
