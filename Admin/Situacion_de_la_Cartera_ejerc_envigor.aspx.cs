...
public partial class Admin_Situacion_de_la_Cartera_ejerc_envigor : System.Web.UI.Page
{
    string cadena;
    ...
    protected void tipo_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        String strConnString = ConfigurationManager.ConnectionStrings["SupervisionConnectionString"].ConnectionString;
        String strQuery = "SELECT CONVERT(NVARCHAR, fecha_rale, 105) AS MOSTRAR, CONVERT (NVARCHAR, fecha_rale, 105) AS VALUE ,CONVERT (NVARCHAR, fecha_rale, 112) AS VALUE1 FROM Rales_Combo WHERE (tipo_rale = @COP_RCV ) AND fecha_rale >= CONVERT(DATE,CONVERT(NVARCHAR(25), '01-11-'+ CONVERT(NVARCHAR(4), YEAR(GETDATE())-1))) ORDER BY VALUE1 ASC";
        SqlConnection con = new SqlConnection(strConnString);
        SqlCommand cmd = new SqlCommand();
        ...
        if (tipo.SelectedValue != "")
        {
            if (rale.SelectedValue != "")
            {
                ...
                {                    
                    ...
                    LabelFecha.Text = "EJERCICIOS EN VIGOR " + tipo.SelectedValue + " RALE AL " + String.Format("{0: dd MMMM  yyyy}", Convert.ToDateTime(rale.SelectedValue));
    ...
    protected void Impri_Click(object sender, EventArgs e)
    {
        ...
        Session["Enca"] = "EJERCICIOS EN VIGOR " + tipo.SelectedValue + " RALE AL " + String.Format("{0: dd MMMM  yyyy}", Convert.ToDateTime(rale.SelectedValue)); ;
        Session["Rep"] = "Vigor";
    ...
    protected void GridView1_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            HeaderCell2.ControlStyle.Font.Size = 11;
            HeaderRow.Cells.Add(HeaderCell2);
            HeaderCell2.BackColor = Color.CornflowerBlue;
            ...
            HeaderCell2.ControlStyle.Font.Size = 11;
            HeaderRow.Cells.Add(HeaderCell2);
            HeaderCell2.BackColor = Color.Cornsilk;
            ...
            HeaderCell2.ControlStyle.Font.Size = 11;
            HeaderRow.Cells.Add(HeaderCell2);
            HeaderCell2.BackColor = Color.Cyan;
            ...
            HeaderCell2.ControlStyle.Font.Size = 11;
            HeaderRow.Cells.Add(HeaderCell2);
            HeaderCell2.BackColor = Color.DarkGoldenrod;
            ...
            HeaderCell2.ControlStyle.Font.Size = 11;
            HeaderRow.Cells.Add(HeaderCell2);
            HeaderCell2.BackColor = Color.DarkGray;
            ...
            HeaderCell2.ControlStyle.Font.Size = 11;
            HeaderRow.Cells.Add(HeaderCell2);
            HeaderCell2.BackColor = Color.DarkKhaki;
            ...
            HeaderCell.ControlStyle.Font.Size = 11;
            HeaderRow1.Cells.Add(HeaderCell);
            HeaderCell.BackColor = Color.CornflowerBlue;
            ...
            HeaderCell.ControlStyle.Font.Size = 11;
            HeaderRow1.Cells.Add(HeaderCell);
            HeaderCell.BackColor = Color.Cornsilk;
            ...
            HeaderCell.ControlStyle.Font.Size = 11;
            HeaderRow1.Cells.Add(HeaderCell);
            HeaderCell.BackColor = Color.Cyan;
            ...
            HeaderCell.ControlStyle.Font.Size = 11;
            HeaderRow1.Cells.Add(HeaderCell);
            HeaderCell.BackColor = Color.DarkGoldenrod;
            ...
            HeaderCell.ControlStyle.Font.Size = 11;
            HeaderRow1.Cells.Add(HeaderCell);
            HeaderCell.BackColor = Color.DarkGray;
            ...
            HeaderCell.ControlStyle.Font.Size = 11;
            HeaderRow1.Cells.Add(HeaderCell);
            HeaderCell.BackColor = Color.DarkKhaki;
    ...
    private void BindGrid()
    {
        try
        {
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["SupervisionConnectionString"].ToString()))
            {
                conn.Open();
                // Create the sample database
                SqlCommand cmd = new SqlCommand("SIT_CAT_VIGOR", conn);
                string ClientIP = GetIP4Address();
