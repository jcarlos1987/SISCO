<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.master" AutoEventWireup="true" CodeFile="Situacion_de_la cartera_ejerci_anteriores.aspx.cs" Inherits="Admin_Situacion_de_la_cartera_ejerci_anteriores" %>
            ...
            <div class="row">
              <div class="col s12 m12 l12">
                <img src="../images/SISCO_2_2_2.png" width="150" align="right" alt="Sistema de Supervisión de Cobranza"/>
                  <h5 class="breadcrumbs-title">Situacion de la Cartera Ejercicios Anteriores</h5>
                <ol class="breadcrumbs">
                  <li><a href="Default.aspx">Inicio</a>
                  </li>
                  <li><a href="#">Comite Delegacional</a>
                  </li>
                  <li class="active">Situacion de la Cartera Ejercicios Anteriores</li>
                </ol>
              </div>
            </div>
                                ...
                                <li class="bold">
                                    ...
                                    <div class="collapsible-body">
                                        <ul>
                                            ...
                                            <li class="active"><a href="Situacion_de_la cartera_ejerci_anteriores.aspx">Situación Ejerc Anterior. <%--de la Cartera Ejer. Anteriores--%></a>
                                            </li>  
                ...
                <div class="card-panel">
                    ...
                    <h4 class="header2">Seleccione:</h4>
                        ...
                        <div class="row">
                          ...
                          <%--   <div class="input-field col s4">
                                    <div class="input-field col s12">
                                       <asp:Button ID="Impri" runat="server"  CssClass="btn cyan" Text="Imprimir Reporte"  Visible="false" />
                                    </div>
                            </div>--%>
     ...
     <asp:UpdatePanel ID="UpdatePanel1" runat="server">
              <ContentTemplate>   
                       ...
                       <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false"  ShowHeader="False" 
                        onrowcreated="GridView1_RowCreated" CssClass="mGrid responsive-table" AlternatingRowStyle-CssClass="alt" PageSize="10" PagerStyle-CssClass="pgr" >
                        <Columns>
