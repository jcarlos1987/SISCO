<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master09.master" AutoEventWireup="true" CodeFile="Seguim_exped_JDSC.aspx.cs" Inherits="Admin_Control_exp_inc09_Seguim_exped_JDSC" %>
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Seguimiento de Expedientes de el Jefe del Departamento de Supervisión Cobranza:</h5>
                <ol class="breadcrumbs">
                  ...
                  <li class="active">Seguimiento de Expedientes de el Jefe de Supervisión Cobranza </li>
                </ol>
              </div>
            </div>
          </div>
                                 ...
                                 <li class="bold">
                                    ...
                                    <div class="collapsible-body">
                                        <ul>
                                            ...
                                            <li> 
                                                <a href="BD_ExcelvsRale.aspx">Base de Datos Personalizada</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <asp:GridView ID="GridView1" AutoGenerateColumns="False" runat="server" DataKeyNames="Registro_Patronal,Razon_Social, Rango, socio, id" DataSourceID="SqlDataSource1"                          
                        onrowcommand="GridView1_RowCommand" CssClass="mGrid responsive-table" AlternatingRowStyle-CssClass="alt"   AllowPaging="true" PageSize="19" PagerStyle-CssClass="pgr">
