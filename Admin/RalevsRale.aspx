<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.master" AutoEventWireup="true" CodeFile="RalevsRale.aspx.cs" Inherits="Admin_RalevsRale" %>
                    ...
                    <h4 class="header2">Comparación de Rales</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col col s12 m4 l4">
                                ...
                                <asp:DropDownList ID="Rale1" runat="server" 
                            ...
                            <div class="col col s12 m4 l4">
                                 ...
                                 <asp:DropDownList ID="Rale2" runat="server" Enabled="false" 
                             ...
                             <div class="col col s12 m6">
                                ...
                                <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal" Enabled="false" AutoPostBack="true" onselectedindexchanged="RadioButtonList1_SelectedIndexChanged">
                                    <asp:ListItem Value="1">Alta de Credito</asp:ListItem>
                                     <asp:ListItem Value="2">Periodo de Credito</asp:ListItem>
                                </asp:RadioButtonList>
                              
                            </div>
                            <div class="col col s12 m6">
                               <label>Periodo de Consulta:</label>
                                <asp:RadioButtonList ID="RadioButtonList2" runat="server" RepeatDirection="Horizontal" Enabled="false" AutoPostBack="true" onselectedindexchanged="RadioButtonList2_SelectedIndexChanged">
                                     <asp:ListItem Value="1">Por Rango</asp:ListItem>
                                    <asp:ListItem Value="2">Por Antigüedad</asp:ListItem>
                                </asp:RadioButtonList>                                
                            </div>
                            <div class="col col s12 m4 l4">
                                <label>Periodo Inicial:</label>  
                               <asp:DropDownList ID="fecha1" runat="server" Enabled="false">
                                    <asp:ListItem Text = "-- Seleccione el Periodo Inicial --" Value = ""></asp:ListItem>
                                </asp:DropDownList>  
                                 <div class="input-field">
                                <div class="errorTxt6"></div>    
                                    </div>                                
                            ...
                            <div class="col col s12 m4 l4">
                                ...
                                <asp:DropDownList ID="fecha2" runat="server" Enabled="false">
                                <asp:ListItem Text = "-- Seleccione el Periodo Final --" Value = ""></asp:ListItem>
                                </asp:DropDownList>  
                                 <div class="input-field">
                                <div class="errorTxt6"></div>    
                                    </div>                              
