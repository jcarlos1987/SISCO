<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.master" AutoEventWireup="true" CodeFile="X_fecha_de_notificacion.aspx.cs" Inherits="Admin_X_fecha_de_notificacion" %>
            ...
            <div class="row">
              <div class="col s12 m12 l12">
               <img src="../images/SISCO_2_2_2.png" width="150" align="right" alt="Sistema de Supervisión de Cobranza"/>
                <h5 class="breadcrumbs-title">Por Fecha de Notificación</h5>
                <ol class="breadcrumbs">
                  <li><a href="index.html">Inicio</a>
                  </li>
                  <li><a href="#">Seguimiento de Bases</a>
                  </li>
                  <li class="active">Fecha de Notificación</li>
                </ol>
              </div>
            </div>
          </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row" runat="server">    
                ...
                <div class="card-panel">
                    <div class="section">
                    <h4 class="header2">Selecciona Rales a Comparar:</h4>
                            <div class="row">
                        <div class="row">
                            <div class="col col s12 m4 l4">
                                <label>Tipo de Rale: </label>  
                                <asp:DropDownList ID="Tipo_Rale" runat="server" 
                                      onselectedindexchanged="Tipo_Rale_SelectedIndexChanged" 
                                     AutoPostBack="True">
                                    <asp:ListItem disabled selected Text = "-- Selecciona Tipo de Rale --" Value = ""></asp:ListItem>
                                </asp:DropDownList>   
                            ...
                            <div class="col col s12 m4 l4">
                                ...
                                <asp:DropDownList ID="Rale_base" runat="server" 
                                   Enabled="false"  onselectedindexchanged="Rale1_SelectedIndexChanged" 
                                    AutoPostBack="True">
                                 <asp:ListItem disabled selected Text = "-- Selecciona Rale Base --" Value = ""></asp:ListItem>
                                </asp:DropDownList>  
                                 <div class="input-field">
                                <div class="errorTxt6"></div>    
                                    </div>                              
                            ...
                            <div class="col col s12 m4 l4">
                                 ...
                                 <asp:DropDownList ID="Rale_comparar" runat="server" Enabled="false" 
                                    onselectedindexchanged="Rale2_SelectedIndexChanged" AutoPostBack="True">
                                  <asp:ListItem disabled selected Text = "-- Selecciona Rale a Comparar --" Value = ""></asp:ListItem> 
                                </asp:DropDownList>  
                                 <div class="input-field">
                                <div class="errorTxt6"></div>    
                                    </div>   
                           ...
                           <div class="col col s12 m4">
                                <label>Subdelegación:</label>
                                 <asp:DropDownList ID="Subdelegacion" runat="server" AutoPostBack="True" Enabled="false" onselectedindexchanged="TIPO_SelectedIndexChanged">
                                </asp:DropDownList>
                                 <div class="input-field">
                                <div class="errorTxt6"></div>    
                                    </div>   
                            ...
                            <div class="col col s12 m4 l6">
                              ...
                              <asp:DropDownList ID="incidencia" runat="server" Enabled="false" AutoPostBack="True" onselectedindexchanged="incidencia_SelectedIndexChanged">
                                  <asp:ListItem disabled selected Text = "-- Selecciona una Incidencia --" Value = ""></asp:ListItem> 
                                </asp:DropDownList>
                                 <div class="input-field">
                                <div class="errorTxt6"></div>    
                                    </div>                                
                                ...
                                <div class="input-field col s4">
                                    <div class="input-field col s12">
                                           ...
                                           <asp:Button ID="Comparar" runat="server" CssClass="btn btn-move-up cyan" Text="Comparar Rale"  onclick="Comparar_Click" />
                                    </div>
                            </div>
                            <div class="input-field col s4">
              ...
              <div class="col s12 m12 l12">
                <ul class="collapsible popout collapsible-accordion" data-collapsible="accordion">
                  <li>
                    ...
                    <div class="collapsible-body">
                      <div id="VtnRsmenPendientes" runat="server" class="fixed-action-btn" style="position: relative; display: inline-block; left:15px; bottom:5px;">
                        ...
                        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="false" GridLines="None" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt"
                         CssClass="mGrid responsive-table" AllowPaging="true" OnPageIndexChanging="GridView2_PageIndexChanging" PageSize="15">
                            <Columns>
                               <asp:BoundField DataField="id" HeaderText=" Num " HeaderStyle-CssClass="center-align"><ItemStyle CssClass="center-align" /></asp:BoundField>
                               <asp:BoundField DataField="sub" HeaderText=" Sub"  HeaderStyle-CssClass="center-align"><ItemStyle CssClass="center-align" /></asp:BoundField>
                               <asp:BoundField DataField="reg_pat" HeaderText=" Registro Patronal" HeaderStyle-CssClass="center-align"><ItemStyle CssClass="center-align" /></asp:BoundField>
                               <asp:BoundField DataField="raz_social" HeaderText=" Razon Social " HeaderStyle-CssClass="center-align"><ItemStyle CssClass="left-align" /></asp:BoundField>
                               <asp:BoundField DataField="creditos" HeaderText=" Creditos " HeaderStyle-CssClass="center-align"><ItemStyle CssClass="right-align" /></asp:BoundField>
                               <asp:BoundField DataField="importe" HeaderText=" Importe " DataFormatString="{0:N2}" HeaderStyle-CssClass="center-align"><ItemStyle CssClass="right-align" /></asp:BoundField>
                               <asp:BoundField DataField="prom_dias" HeaderText=" Prome. Dias " HeaderStyle-CssClass="center-align"><ItemStyle CssClass="right-align" /></asp:BoundField>
                               <asp:BoundField DataField="anti" HeaderText=" Antigüedad " HeaderStyle-CssClass="center-align"><ItemStyle CssClass="left-align" /></asp:BoundField>
                            </Columns>                                 
                                                                  
                        <emptydatatemplate>
                        <div id='card-alert' class='card red'>
                                    <div class='card-content white-text'>
                                      <p><i class='mdi-alert-error'></i> Alerta : No hay Registros que Mostrar Detalle de Creditos Pendientes</p>
                                    </div>
                                    <button type='button' class='close white-text' data-dismiss='alert' aria-label='Close'>
                                      <span aria-hidden='true'>×</span>
                                    </button>
                  ...
                  <li>
                    <div id="DetallePendientes" runat="server" class="collapsible-header"><i class="mdi-communication-chat"></i>Detalle de Creditos Pendientes</div>
                    <div class="collapsible-body">
                        <div id="DivDetallePendientes" runat="server" class="fixed-action-btn" style="position: relative; display: inline-block; left:15px; bottom:5px;">
                                    <a class="btn-floating">
                                        <i class="mdi-editor-vertical-align-bottom"></i>
                                    </a>
                                    <ul>
                  ...
                  <li>
                      <div id="ResumenMovimientos" runat="server" class="collapsible-header"><i class="mdi-content-reply-all"></i>Resumen de Movimientos a otras Incidencias</div>
                      <div class="collapsible-body">
