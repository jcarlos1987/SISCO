<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.master" AutoEventWireup="true" CodeFile="RvsR.aspx.cs" Inherits="Admin_RvsR" %>
                        ...
                        <li class="no-padding">
                            <ul class="collapsible">
                                <li class="bold ">
                                    ...
                                    <div class="collapsible-body">
                                        <ul>
                                            <li class="active"><a href="../Admin/RalevsRale.aspx">Rale vs Rale</a>
                                            </li>
                                            <li>
            ...
            <div class="row">
              <div class="col s12 m12 l12">
                <img src="../images/SISCO_2_2_2.png" width="150" align="right" alt="Sistema de Supervisión de Cobranza"/>
                  <h5 class="breadcrumbs-title">RALE VS RALE</h5>
                <ol class="breadcrumbs">
                  <li><a href="index.html">Inicio</a>
                  </li>
                  <li><a href="#">Seguimiento de Bases</a>
                  </li>
                  <li class="active">Rale vs Rale</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <div class="col s12 m12 l12">
                <ul class="collapsible popout collapsible-accordion" data-collapsible="accordion">
                  <li>
                    ...
                    <div class="collapsible-body">
                      <div class="fixed-action-btn" style="position: relative; display: inline-block; left:15px; bottom:5px;">
                  ...
                  <li>
                    <div id="DetallePendientes" runat="server" class="collapsible-header"><i class="mdi-editor-border-color"></i>Detalle de Creditos Pendientes</div>
                    <div class="collapsible-body">
                        <div class="fixed-action-btn" style="position: relative; display: inline-block; left:15px; bottom:5px;">
                                    <a class="btn-floating">
                                        <i class="mdi-editor-vertical-align-bottom"></i>
