...
public partial class Admin_Control_exp_inc09_Seguim_exped_JDSC : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Aceptado")
        {
            ...
            {
                cnn.Open();
                string status = "AUTORIZACION JAC";
                SqlCommand cmd = new SqlCommand();
                cmd.CommandText = "UPDATE [Supervision].[dbo].[Registro_Expedientes] SET [estatus] ='" + status + "', [fec_env_jac2]='" + String.Format("{0: dd/MM/yyyy hh:mm:ss}", DateTime.Now) + "'  WHERE [Registro_Patronal] = '" + Code + "' ";
                cmd.Connection = cnn;
            ...
            {
                Literal5.Text = ex.Message + "Error ACTUALIZAR <br>";
            }
