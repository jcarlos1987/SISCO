...
public partial class Admin_RalevsRale : System.Web.UI.Page
{
                            ...
                            if (RadioButtonList2.SelectedValue == "1")
                            {
                                if (fecha1.SelectedValue != "" && fecha2.SelectedValue != "")
                                {
                                    if (Convert.ToInt32(fecha1.SelectedValue) <= Convert.ToInt32(fecha2.SelectedValue))
                                    {
                                        ...
                                        Response.Cookies["Tipo_Rale"].Value = Tipo_Rale.SelectedValue;
                                        Response.Cookies["Rale_Base"].Value = Convert.ToString(Rale1.SelectedItem);
                                        Response.Cookies["Rale_Comp"].Value = Rale2.SelectedValue;
                                        Response.Cookies["CC"].Value = RadioButtonList1.SelectedValue;
                                        Response.Cookies["RA"].Value = RadioButtonList2.SelectedValue;
                                        Response.Cookies["Per_Ini"].Value = fecha1.SelectedValue;
                                        Response.Cookies["Per_Fin"].Value = fecha2.SelectedValue;

                                        Response.Cookies["Tipo_Rale"].Expires = DateTime.Now.AddYears(2);
                                        Response.Cookies["Rale_Base"].Expires = DateTime.Now.AddYears(2);
                                        Response.Cookies["Rale_Comp"].Expires = DateTime.Now.AddYears(2);
                                        Response.Cookies["CC"].Expires = DateTime.Now.AddYears(2);
                                        Response.Cookies["RA"].Expires = DateTime.Now.AddYears(2);
                                        Response.Cookies["Per_Ini"].Expires = DateTime.Now.AddYears(2);
                                        Response.Cookies["Per_Fin"].Expires = DateTime.Now.AddYears(2);
                                        Response.Redirect("RvsR.aspx");
                                        //Server.Transfer("");                                        
                                    }
                                    else
                                    {
