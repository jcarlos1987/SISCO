<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.master" AutoEventWireup="true" CodeFile="BD_ExcelvsRale.aspx.cs" Inherits="Admin_BD_ExcelvsRale" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="row" runat="server">    
                ...
                <div class="card-panel">
                    <div class="section">
                    <h4 class="header2">Comparación de una Base de Datos con un Rale</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col col s12 m4 l4">
                                ...
                                <asp:DropDownList ID="Tipo_Rale" runat="server" onselectedindexchanged="Tipo_Rale_SelectedIndexChanged" 
                                     AutoPostBack="True">
                            ...
                            <div class="col col s12 m4 l4">
                                 <label>Base de Datos:</label>
                                  <asp:DropDownList ID="Rale1" runat="server" Enabled="false"  onselectedindexchanged="Rale1_SelectedIndexChanged" 
                                    AutoPostBack="True">
                            ...
                            <div class="col col s12 m4 l4">
                                ...
                                <asp:DropDownList ID="Rale2" runat="server" Enabled="false" AutoPostBack="True" onselectedindexchanged="Rale2_SelectedIndexChanged">
                                  <asp:ListItem Text = "-- Selecciona Rale a Comparar --" Value = ""></asp:ListItem> 
                                </asp:DropDownList>
                                 <div class="input-field">
                                <div class="errorTxt6"></div>    
                                    </div>   
                            ...
                            <div class="col col s12 m6">
                               <label>Periodo de Consulta:</label> 
                                 <asp:RadioButtonList ID="RadioButtonList2" runat="server" Enabled="false" 
                                    CssClass="form-control" RepeatDirection="Horizontal" Width="320px" 
                            ...
                            <div class="col col s12 m4 l4">
                              ...
                              <asp:DropDownList ID="fecha1" runat="server" Enabled="false"  
                                    Width="260px" class="form-control">
                            ...
                            <div class="col col s12 m4 l4">
                             ...
                             <div class="input-field col s4">
                                    <div class="input-field col s12">
                                          ...
                                          <asp:Button ID="Comparar" runat="server"  CssClass="btn btn-login" Text="Comparar Rale"  onclick="Comparar_Click" />
                                    </div>
                            </div>
                            <div class="input-field col s4">
